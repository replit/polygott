...
echo "ZWNobyAiaGVsbG8gd29ybGQi"  | base64 --decode | docker run --rm -i polygott run-project -s -l nim | diff -u --label "nim" <( echo "Q0M6IG1haW4KQ0M6IHN0ZGxpYl9zeXN0ZW0KaGVsbG8gd29ybGQK" | base64 --decode ) - && echo ✓ nim:hello
...
echo "aW1wb3J0IGVuc3VyZXBpcDsgcHJpbnQoZW5zdXJlcGlwLnZlcnNpb24oKSk="  | base64 --decode | docker run --rm -i polygott run-project -s -l python3 | diff -u --label "python3" <( echo "MTkuMi4zCg==" | base64 --decode ) - && echo ✓ python3:venv
...
echo "aW1wb3J0IHB5Z2FtZQ=="  | base64 --decode | docker run --rm -i polygott run-project -s -l pygame | diff -u --label "pygame" <( echo "cHlnYW1lIDEuOS42CkhlbGxvIGZyb20gdGhlIHB5Z2FtZSBjb21tdW5pdHkuIGh0dHBzOi8vd3d3LnB5Z2FtZS5vcmcvY29udHJpYnV0ZS5odG1sCg==" | base64 --decode ) - && echo ✓ pygame:pygame
...
echo "aW1wb3J0IHB5eGVs"  | base64 --decode | docker run --rm -i polygott run-project -s -l pyxel | diff -u --label "pyxel" <( echo "" | base64 --decode ) - && echo ✓ pyxel:pyxel
